...
export const BlogCard: React.FC<BlogCardProps> = ({ post }) => {
  return (
    <Link
      to={`/blog/${post.slug}`}
      className="group block glass-panel rounded-[30px] px-6 py-8 md:px-8 md:py-10 transition-transform duration-500 hover:-translate-y-2"
    >
      ...
      <h3 className="mt-4 text-2xl font-semibold tracking-tight text-gray-800 transition-colors duration-300 group-hover:text-indigo-500">
        {post.title}
      </h3>
